...
import com.kharazmiuniversity.khu.data.UploadImageController;
...
public class VideoActivity extends AppCompatActivity {
    ...
    private void uploadFile() {
        if (video == null || video.equals("")) {
            ...
            KhuAPI getResponse = UploadImageController.getRetrofit().create(KhuAPI.class);
            Call<UploadImageResponse> call = getResponse.upload("token", map);
